...
img: ../src/assets/work-media/DeepSpaceDonuts/Deep Space Donuts Logo.png
...
<div>
  <img src="../src/assets/work-media/DeepSpaceDonuts/DSD-Feature Header.png" alt="Feature Header" />
</div>
...
<Video
  path="../src/assets/work-media/DeepSpaceDonuts/Deep Space Donuts video.mp4"
  autoplay="autoplay"
  loop="loop"
  muted="muted"
/>
...
<div className="flex-container">
  <img class="lightbox-image" src="../src/assets/work-media/DeepSpaceDonuts/Unity Components.png" alt="Example Unity Scriptable Objects Diagram" />
...
<Video
    path="../src/assets/work-media/DeepSpaceDonuts/DSD-Gameplay-GMTK-Jam.mp4"
    autoplay="autoplay"
    loop="loop"
    muted="muted"
/>
...
<div className="flex-container">
  <img class="lightbox-image" src="../src/assets/work-media/DeepSpaceDonuts/DSD-Design Decisions.png" alt="Screenshot of ship transit design." />
...
<div className="flex-container">
  <img class="lightbox-image" src="../src/assets/work-media/DeepSpaceDonuts/DSD-Kast-Style-Guide.png" alt="Art style guide for Kast nonbinary alien." />
...
<div className="flex-container">
  <img class="lightbox-image" src="../src/assets/work-media/DeepSpaceDonuts/DSD-Accessibility.png" alt="Xbox accessibility controller." />
...
<div className="flex-container">
  <img class="lightbox-image" src="../src/assets/work-media/DeepSpaceDonuts/DSD-Storyboarding.png" alt="Example storyboarding from Deep Space Donuts." />
...
<div className="flex-container">
  <img class="lightbox-image" src="../src/assets/work-media/DeepSpaceDonuts/DSD-Playtesting.png" alt="Photo from a play test for Deep Space Donuts." />
...
<div className="flex-container">
  <img class="lightbox-image" src="../src/assets/work-media/DeepSpaceDonuts/Onboarding Doc.png" alt="Screenshot of onboarding document." />
